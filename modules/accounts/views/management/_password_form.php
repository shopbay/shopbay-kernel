...
<div class="form">
    ...
    <?php if (!isset($hideCurrentPassword)||(isset($hideCurrentPassword) && !$hideCurrentPassword)):?>
    <div class="row">
            <?php echo $form->labelEx($model,'currentPassword'); ?>
            <?php echo $form->passwordField($model,'currentPassword',array('size'=>30,'maxlength'=>PasswordForm::POLICY_LENGTH_MAXIMUM,'style'=>'font-size:1.5em')); ?>
