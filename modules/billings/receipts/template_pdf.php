<html>
    ...
    <body>
        ...
        <p><?php echo Sii::tp('sii','We received payment for your {app} subscription. Thanks for business!',['{app}'=>$app],$model->fileLocale);?></p>
        ...
        <table style="margin-top:20px;">
            ...
            <?php foreach ($model->itemsData as $item): ?>
                <?php foreach ($fields as $field): ?>
                    ...
                    <tr class="border_bottom">
                        <td><?php echo Sii::tl('sii','Service Validity',$model->fileLocale);?></td>
                        <td><?php echo Sii::tp('sii','{start_date} to {end_date}',['{start_date}'=>$item[$field],'{end_date}'=>$item['service_end']],$model->fileLocale);?></td>
                    </tr>
                    <?php else: ?>
                    <tr class="border_bottom">
