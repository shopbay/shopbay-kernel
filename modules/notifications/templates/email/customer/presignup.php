            ...
            <tr>
                <td width="60%" style="padding-top: 10px;padding-left:20px;">
                    ...
                    <div style="margin-top:10px;">
                        ...
                        <p><?php echo Sii::t('sii','Thanks for registering with {shop} using {network} account.',array('{shop}'=>$model->shopName,'{network}'=>$network));?></p>
                    ...
                    <div style="margin-top:10px;">
                        ...
                        <div style="text-align: center;width:100%;">
                            <a href="<?php echo CustomerAccount::model()->getActivationUrl($model->activate_str,$network);?>" style="display:block;color:white;text-align:center;width:100%;background:lightskyblue;font-size:3em;margin: 30px 0px;">
