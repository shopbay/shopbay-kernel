            ...
            <tr>
                <td width="60%" style="padding-top: 10px;padding-left:20px;">
                    ...
                    <div style="margin-top:10px;">
                        ...
                        <p><?php echo Sii::t('sii','You received this email because you have recently changed your email address for your account at {shop}.',array('{shop}'=>$model->shopName));?></p>
