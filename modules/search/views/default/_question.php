            ...
            'value'=>$this->widget('common.widgets.SDetailView', array(
                ...
                'attributes'=>array(
                    array(
                        ...
                        'value'=>CHtml::link(CHtml::encode($data->model->title), $data->model->url),
                    ),
                    array(
                        'type'=>'raw',
                        'template'=>'<div class="element">{value}</div>',
                        'value'=>'<span class="avatar">'.$data->model->account->getAvatar(Image::VERSION_XXXSMALL).'</span>'.
                                 CHtml::encode($data->model->account->nickname),
                    ),
                    array(
                        'type'=>'raw',
                        'template'=>'<div class="element">{value}</div>',
