...
$this->breadcrumbs=array(
        ...
        Sii::t('sii','{action} Plan',array('{action}'=>ucfirst($action))),
);
$this->menu=array();
...
$this->widget('common.widgets.spage.SPage',array(
    ...
    'heading'=> array(
        'name'=> Sii::t('sii','{action} Plan',array('{action}'=>ucfirst($action))),
        'superscript'=>null,
        'subscript'=>null,
    ),
    'body'=>$this->renderPartial('_plans',array('dataProvider'=>$dataProvider,'searchModel'=>$searchModel), true),
    'csrfToken' => true,
));