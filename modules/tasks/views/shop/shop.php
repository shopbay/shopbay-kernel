...
$this->breadcrumbs=array(
        ...
        Sii::t('sii','{action} Shop',array('{action}'=>ucfirst($action))),
);
$this->menu=array();
...
$this->widget('common.widgets.spage.SPage',array(
    ...
    'heading'=> array(
        'name'=> Sii::t('sii','{action} Shops',array('{action}'=>ucfirst($action))),
        'superscript'=>null,
        'subscript'=>null,
    ),
    'body'=>$this->renderPartial('_shops',array('dataProvider'=>$dataProvider,'searchModel'=>$searchModel), true),
    'csrfToken' => true,
));