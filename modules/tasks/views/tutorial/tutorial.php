...
$this->breadcrumbs=array(
        ...
        Sii::t('sii','{action} Tutorial',array('{action}'=>Process::getActionText(ucfirst($action)))),
);
$this->menu=array();
...
$this->widget('common.widgets.spage.SPage',array(
    ...
    'heading'=> array(
        'name'=> Sii::t('sii','{action} Tutorial',array('{action}'=>Process::getActionText(ucfirst($action)))),
        'superscript'=>null,
        'subscript'=>null,
    ),
    'body'=>$this->renderPartial('_tutorials',array('dataProvider'=>$dataProvider,'searchModel'=>$searchModel), true),
    'csrfToken' => true,
));