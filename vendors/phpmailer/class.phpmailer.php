<?php
/**
 * Modification to prevent error below:
 * 2011/09/26 23:16:31 [error] [php] Cannot modify header information - headers already sent by (output started at ../common/vendors/phpmailer/class.phpmailer.php:640)
 * 
 * PostSend() - Do not echo error message when phpmailerException is thrown
 * 
 * @author kw.lok
 * 
 */
